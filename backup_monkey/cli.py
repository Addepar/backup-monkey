...
def run():
    ...
    parser.add_argument('--dryrun', action='store_true', default=False,
                        help='Dry Run Mode, do not actually do anything')

    parser.add_argument('--excludetag', nargs="+", 
                        help='Exclude any volume with this tag.')

    parser.add_argument('--removeold', default=0, type=int,
                        help='Remove any snapshot (generated by this script) older than N days E.g. --removeold 180')
